<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/www/wwwroot/www.jisitech.com/./application/admin/view/article/lst.html";i:1548162530;s:75:"/www/wwwroot/www.jisitech.com/application/admin/view/template/template.html";i:1549977998;s:72:"/www/wwwroot/www.jisitech.com/application/admin/view/template/style.html";i:1547206380;s:71:"/www/wwwroot/www.jisitech.com/application/admin/view/template/base.html";i:1547794034;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="<?php echo url('admin/cate/lst'); ?>">栏目</a>
        <a href="<?php echo url('admin/article/lst'); ?>">文章</a>
        <a>
          <cite>文章列表</cite></a>
      </span>
...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn"
                onclick="x_admin_show('添加文章','<?php echo url('admin/article/add',array('cate_id'=>\think\Request::instance()->param('cate_id'))); ?>',750,500)">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            text-overflow:ellipsis;/*超出部分文字以...显示*/"><?php echo $vo['title']; ?>
            </td>
            <td><img src="/public//<?php echo $vo['thumb']; ?>" style="width: 50px" alt=""></td>

            <td>
                <?php $_result=cateTree('cate');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($vo['cate_id'] == $v['id']): ?><?php echo $v['cate_name']; endif; endforeach; endif; else: echo "" ;endif; ?>
            </td>
...
<td class="td-manage">
    ...
    <a title="编辑" onclick="x_admin_show('修改文章','<?php echo url('admin/article/edit',array('id'=>$vo['id'])); ?>',750,500)"
       href="javascript:;">
