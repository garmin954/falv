                ...
                <div class="layui-tab-content " >
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text"  name="author" required="" lay-verify="required" value=""
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                            ...
                            <div class="layui-input-inline">
                                <select name="cate_id" >
                                    ...
                                    <?php echo str_repeat("-----|",$cl['level']); ?>
                                        <option <?php if($cl['id'] == \think\Request::instance()->param('cate_id')): ?>selected<?php endif; ?> value="<?php echo $cl['id']; ?>"><?php echo $cl['cate_name']; ?></option>
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                ...
                                <textarea name="desc"   id="" cols="60" rows="5" style="border:1px solid #e6e6e6;padding: 10px"></textarea>
                            </div>
                            <div class="layui-form-mid layui-word-aux">
                    ...
                    <div class="layui-tab-item">
                        <div class="layui-form-item" id="yl-show">
                            ...
                            <div class="layui-input-inline" style="width: 100%;">
                                ...
                                <input type="hidden"  name="thumb_list"  value="">
                            </div>
