<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/www/wwwroot/www.jisitech.com/./application/admin/view/advert/lst.html";i:1548161706;s:75:"/www/wwwroot/www.jisitech.com/application/admin/view/template/template.html";i:1549977998;s:72:"/www/wwwroot/www.jisitech.com/application/admin/view/template/style.html";i:1547206380;s:71:"/www/wwwroot/www.jisitech.com/application/admin/view/template/base.html";i:1547794034;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
  ...
  <xblock>
    ...
    <button class="layui-btn" onclick="x_admin_show('添加广告','<?php echo url('admin/advert/add'); ?>',750,500)"><i class="layui-icon"></i>添加</button>
  ...
  <table class="layui-table">
    ...
    <tr   >
      <td >
         <i class="iconfont" id="off" onclick="showadvert(this)">&#xe600;</i>
      </td>
      ...
      <td>
        ...
        <?php $_result=cateTree('cate');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($vo['cate_id'] == $v['id']): ?><?php echo $v['advert_name']; endif; endforeach; endif; else: echo "" ;endif; if($vo['cate_id'] == 0): ?>首页<?php endif; ?>
      </td>
...
<td class="td-manage">
  ...
  <a title="编辑" onclick="x_admin_show('修改','<?php echo url('admin/advert/edit',array('id'=>$vo['id'])); ?>',750,500)" href="javascript:;">
