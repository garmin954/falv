        ...
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            ...
            <div class="layui-tab-content " >
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="cname" name="cate_name" required="" lay-verify="required" value="<?php echo $lists['cate_name']; ?>"
                    ...
                    <div class="layui-form-item">
                        <label   class="layui-form-label">
                            <span class="x-red"></span>栏目简序
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" name="sort_name" value="<?php echo $lists['sort_name']; ?>" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="pid" >
                                ...
                                <option <?php if($cl['id'] == $lists['pid']): ?>selected<?php endif; ?> value="<?php echo $cl['id']; ?>"><?php echo str_repeat("-----|",$cl['level']); ?><?php echo $cl['cate_name']; ?></option>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="type" value="1" title="列表页" <?php if($lists['type'] == 1): ?>checked<?php endif; ?>><div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i><div>列表页</div></div>
                            <input type="radio" name="type" value="0" title="内容页"<?php if($lists['type'] == 0): ?>checked<?php endif; ?>><div class="layui-unselect layui-form-radio layui-form-radioed"><i class="layui-anim layui-icon"></i><div>内容页</div></div>
                        </div>
                    </div>
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <textarea name="cate_desc"   id="" cols="60" rows="5" style="border:1px solid #e6e6e6;padding: 10px"> <?php echo $lists['cate_desc']; ?></textarea>
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <textarea name="cate_seo"   id="" cols="60" rows="5" style="border:1px solid #e6e6e6;padding: 10px"><?php echo $lists['cate_seo']; ?></textarea>
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                ...
                <div class="layui-tab-item">
                    ...
                    <textarea name="content1" id="containers"  type="text/plain" ><?php echo htmlspecialchars_decode($lists['content']); ?></textarea>
