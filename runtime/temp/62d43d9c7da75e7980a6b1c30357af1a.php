...
<div class="x-body">
  ...
  <xblock>
    ...
    <button class="layui-btn" onclick="x_admin_show('添加广告','<?php echo url('admin/admin/add'); ?>',700,500)"><i class="layui-icon"></i>添加</button>
  ...
  <table class="layui-table">
    ...
    <tr >
      <td > <div class="layui-unselect header layui-form-checkbox" lay-skin="primary"><i class="layui-icon">&#xe605;</i></div>
      </td>
      <td><?php echo $vo['id']; ?></td>
      <td><?php echo $vo['username']; ?></td>
      <td  onabort="showTip(this)"><?php echo date("Y-m-d H:i:s",$vo['time']); ?>
        <i class="iconfont" id="off"  >&#xe606;</i>
      </td>
...
<td class="td-manage">
  ...
  <a title="编辑" onclick="x_admin_show('修改','<?php echo url('admin/admin/edit',array('id'=>$vo['id'])); ?>',650,500)" href="javascript:;">
