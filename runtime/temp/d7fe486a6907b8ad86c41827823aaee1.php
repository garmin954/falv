                ...
                <div class="layui-tab-item">
                    <div class="layui-form-item" id="yl-show">
                        ...
                        <div id="thumb_list" style="margin:10px 110px;">
                            ...
                            <?php $_5cd02418ede9a=cutImg($lists['thumb_list']); if(is_array($_5cd02418ede9a) || $_5cd02418ede9a instanceof \think\Collection || $_5cd02418ede9a instanceof \think\Paginator): if( count($_5cd02418ede9a)==0 ) : echo "" ;else: foreach($_5cd02418ede9a as $key=>$img): ?>
