<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/www/wwwroot/www.jisitech.com/./application/admin/view/system/lst.html";i:1548163598;s:75:"/www/wwwroot/www.jisitech.com/application/admin/view/template/template.html";i:1549977998;s:72:"/www/wwwroot/www.jisitech.com/application/admin/view/template/style.html";i:1547206380;s:71:"/www/wwwroot/www.jisitech.com/application/admin/view/template/base.html";i:1547794034;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加系统配置','<?php echo url('admin/System/add'); ?>',750,500)"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <tr>
            ...
            <td>
                <?php if($vo['type'] == 1): ?>输入框
                <?php elseif($vo['type'] == 2): ?>下拉框
                <?php elseif($vo['type'] == 3): ?>复选框
                <?php elseif($vo['type'] == 4): ?>开关型选框
                <?php elseif($vo['type'] == 5): ?>单选框
                <?php elseif($vo['type'] == 6): ?>文本域
                <?php elseif($vo['type'] == 7): ?>附件<?php endif; ?></td>
            <td><?php echo $vo['type_id']; ?></td>
            <td><?php echo date("Y-m-d H:i:s",$vo['time']); ?></td>

            <td class="td-status">
              <div id="<?php echo $vo['id']; ?>" onclick="closes(this)" class="layui-unselect layui-form-switch <?php if($vo['status'] == 1): ?>layui-form-onswitch<?php endif; ?>" lay-skin="_switch"><em><?php if($vo['status'] == 1): ?>开启<?php else: ?>关闭<?php endif; ?></em><i></i></div>
            </td>
            <td class="td-manage">

              <a title="编辑" onclick="x_admin_show('添加系统配置','<?php echo url('admin/System/edit',array('id'=>$vo['id'])); ?>',750,500)" href="javascript:;">
