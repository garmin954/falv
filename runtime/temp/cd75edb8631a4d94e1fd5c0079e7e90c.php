                    ...
                    <ul class="ys-con">
                        <li class="item">
                            <div class="ys-left col-md-6 col-sm-6 col-xs-12">
                                <h3><?php echo $config['hexin1']; ?></h3>

                                <p class="hidden-sm">
                                <p><strong><span style="font-size: 16px;"><?php echo $config['hexinm1']; ?></span></strong>
                                </p>
                                <p>
                            ...
                            <div class="ys-img col-md-6 col-sm-6 col-xs-12">
                                <img src="/public/<?php echo $config['hexinimg1']; ?>"/>

                            </div>
                        </li>
                        <li class="item">
                            <div class="ys-left col-md-6 col-sm-6 col-xs-12">
                                <h3><?php echo $config['hexin2']; ?></h3>
                                <p class="hidden-sm">
                                <p><strong><span style="font-size: 16px;"><?php echo $config['hexinm2']; ?></span></strong>
                                </p>
                                <p>&nbsp;</p>
                                </p>
                            ...
                            <div class="ys-img col-md-6 col-sm-6 col-xs-12">
                                <img src="/public/<?php echo $config['hexinimg2']; ?>"/>

                            </div>
                        </li>
                        <li class="item">
                            <div class="ys-left col-md-6 col-sm-6 col-xs-12">
                                <h3><?php echo $config['hexin3']; ?></h3>
                                <p class="hidden-sm">
                                <p><strong><span style="font-size: 16px;"><?php echo $config['hexinm3']; ?></span></strong>
                                </p>
                                <p>&nbsp;</p>
                                </p>
                            ...
                            <div class="ys-img col-md-6 col-sm-6 col-xs-12">
                                <img src="/public/<?php echo $config['hexinimg3']; ?>"/>
