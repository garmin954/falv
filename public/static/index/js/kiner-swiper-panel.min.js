(function (window, undefined) {
    ...
    (function (window, undefined) {
        var cachedruns, assertGetIdNotName, Expr, getText, isXML, contains, compile, sortOrder, hasDuplicate,
            outermostContext, baseHasDuplicate = true, strundefined = "undefined",
            ...
            rsibling = /[\x20\t\r\n\f]*[+~]/, rendsWithNot = /:not\($/, rheader = /h\d/i,
            rinputs = /input|select|textarea|button/i, rbackslash = /\\(?!\\)/g, matchExpr = {
            ...
            (function () {
                ...
                select = function (selector, context, results, seed, xml) {
                    if (!seed && !xml && !rbuggyQSA.test(selector)) {
                        var groups, i, old = true, nid = expando, newContext = context,
    ...
    jQuery.extend({
        clone: function (elem, dataAndEvents, deepDataAndEvents) {
            ...
            var data, id, elem, type, i = 0, internalKey = jQuery.expando, cache = jQuery.cache,
    ...
    function getWidthOrHeight(elem, name, extra) {
        var val = name === "width" ? elem.offsetWidth : elem.offsetHeight, valueIsBorderBox = true,
    ...
    function inspectPrefiltersOrTransports(structure, options, originalOptions, jqXHR, dataType, inspected) {
        ...
        var selection, list = structure[dataType], i = 0, length = list ? list.length : 0,
    ...
    jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
        var callbackName, overwritten, responseContainer, data = s.data, url = s.url, hasCallback = s.jsonp !== false,
    ...
    function Animation(elem, properties, options) {
        var result, index = 0, tweenerIndex = 0, length = animationPrefilters.length,
...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        var isTouched, isMoved, allowTouchCallbacks, touchStartTime, isScrolling, currentTranslate, startTranslate,
            allowThresholdMove, formElements = 'input, select, textarea, button', lastClickTime = Date.now(),
...
;(function (win, doc, $) {
    $.kinerSwiperPanel = function (options) {
        ...
        var nav = $(opts.navSelector), con = $(opts.conSelector);
        var returnObj = {
            slideTo: function (index) {
                selectPanel(index, 2)
            }, on: function (name, handler) {
                handlers[name] = handler
            }, handlerNameList: {"change": "change"}
        };
        var handlers = {};
        ...
        nav.find(".realBorder").css({width: (1 / len) * 100 + "%"});
        ...
        function movePanel(width, swiper) {
            ...
            if (res != undefined) {
                ...
                var y = (x / (len * width)) * 100 - nowLeft, pre = 0;
                pre = nowLeft + y;
                if (swiper) {
        ...
        var mySwiper = new Swiper(opts.conSelector + '.swiper-container', {
            ...
            onTransitionStart: function (swiper) {
                var pre = 0;
                var direction = getDirection(swiper), index = swiper.activeIndex;
                if (index == 0) {
                    if (direction == "right") {
    ...
    $.kinerSwiperPanel.options = {time: 300}
})(window, document, $);
$(function () {
    var ksp = $.kinerSwiperPanel({navSelector: ".kinerNav", conSelector: ".kinerContent"});
    $('.btn').click(function () {
